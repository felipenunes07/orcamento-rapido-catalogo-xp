        ...
        <Table>
          <TableHeader className="z-20">
            <TableRow className="hover:bg-transparent">
              <TableHead
                className={`sticky top-[52px] z-20 w-[200px] bg-background dark:bg-slate-900 border-b ${compactView ? 'py-2 text-sm' : ''}`}
              >
                Modelo
              </TableHead>
              <TableHead
                className={`sticky top-[52px] z-20 w-[150px] bg-background dark:bg-slate-900 border-b ${compactView ? 'py-2 text-sm' : ''}`}
              >
                Cor
              </TableHead>
              <TableHead className={`sticky top-[52px] z-20 bg-background dark:bg-slate-900 border-b ${compactView ? 'py-2 text-sm' : ''}`}>
                Qualidade
              </TableHead>
              <TableHead
                className={`sticky top-[52px] z-20 text-right bg-background dark:bg-slate-900 border-b ${compactView ? 'py-2 text-sm' : ''}`}
              >
                Valor
              </TableHead>
              <TableHead
                className={`sticky top-[52px] z-20 text-center bg-background dark:bg-slate-900 border-b ${compactView ? 'py-2 text-sm' : ''}`}
              >
                Quantidade
              </TableHead>
              <TableHead
