          ...
          <div className="max-w-3xl mx-auto">
            ...
            <section className="bg-slate-50 dark:bg-gray-900/50 p-4 sm:p-6 rounded-2xl border border-slate-100 dark:border-gray-800">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-gray-800 p-5 rounded-xl border border-slate-200 dark:border-gray-700 shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-100 dark:hover:border-gray-700">
            ...
            <div className="mt-8 p-6 rounded-2xl text-center border border-blue-100 dark:border-gray-700/80 bg-gradient-to-br from-blue-50/50 to-white dark:from-gray-800/40 dark:to-gray-800/80 shadow-sm">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl transition-all duration-300 shadow-[0_4px_15px_rgba(34,197,94,0.3)] hover:shadow-[0_6px_22px_rgba(34,197,94,0.5)] hover:-translate-y-0.5 active:scale-95 font-bold"
              >
